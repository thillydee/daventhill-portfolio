...
export const strings = {
  en: {
    ...
    home: {
      ...
      knowledgeHeading: "Explainers grounded in what I've actually built and led",
      browseKnowledge: 'Browse the knowledge base →',
      faqEyebrow: 'FAQ',
  ...
  de: {
    ...
    home: {
      ...
      knowledgeEyebrow: 'Wissensdatenbank',
      knowledgeHeading: 'Wissen aus dem, was ich selbst aufgebaut und geleitet habe',
      browseKnowledge: 'Wissensdatenbank durchstöbern →',
      faqEyebrow: 'FAQ',
